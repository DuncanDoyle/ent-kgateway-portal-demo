...
printf "\nDeploy HTTPBin APIDoc ...\n"
kubectl apply -f apis/httpbin/httpbin-apidoc-2.yaml

printf "\nDeploy the HTTPBin HTTPRoute (delegatee) and the HTTP APIProduct ...\n"
kubectl apply -f apiproducts/httpbin/httpbin-apiproduct-httproute-2.yaml
kubectl apply -f apiproducts/httpbin/httpbin-apiproduct-2.yaml
kubectl apply -f referencegrants/httpbin-ns/portal-kgateway-system-apiproduct-rg.yaml
